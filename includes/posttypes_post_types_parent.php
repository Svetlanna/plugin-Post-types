...
class WEOC_post_types_parent {
    ...
    public function cpt_init() {
        add_action( 'init', array($this,'customPostType_weoc_weoc_post_types_parent'));
    ...
    ///////////////////////////////////////////
    public function customPostType_weoc_weoc_post_types_parent() {
        ...
        $args = array(
            'label'               => __( $this->cpt_name, 'weoc' ),
            'description'         => __( $this->cpt_name, 'weoc' ),
            'labels'              =>  $this->labels,
